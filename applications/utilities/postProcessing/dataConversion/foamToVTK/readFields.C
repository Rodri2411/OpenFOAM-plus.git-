...
)
{
    ...
    return getField<GeoField>(objects.lookup(fieldName), mesh, syncPar);
}
...
)
{
    ...
    return getField<GeoField>(objects.lookup(fieldName), proxy, syncPar);
}
...
)
{
    ...
    (
      ...
      : objects.sortedNames(GeoField::typeName, selection)
    );
    ...
    {
        auto tfield =
            getField<GeoField>(objects.lookup(fieldName), mesh, syncPar);
...
)
{
    ...
    {
        auto tfield =
            getField<GeoField>(objects.lookup(fieldName), proxy, syncPar);
